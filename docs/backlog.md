...
1. **Phase 0 (shipped 2026-09-16):** real Postgres connection pool (`core/db.py`) + gunicorn workers 1→2 — no new infra.
...
- [x] Phase 0 shipped: connection pool, gunicorn workers=2, tests green
