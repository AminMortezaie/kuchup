...
> **Archived 2026-09-16.** Neon → AWS Postgres cutover (complete). Day-to-day Postgres ops: [aws-postgres.md](../operations/aws-postgres.md).
...
- [aws-postgres.md](../operations/aws-postgres.md) — living Postgres ops
- [contributing.md](../contributing.md) — `DATABASE_URL`, local panel
- [`.env.example`](../../.env.example) — `DATABASE_URL` format
- [`relocation_jobs/core/db.py`](../../relocation_jobs/core/db.py) — connection pool

These related links were the migration-era checklist; Render and `CLAUDE.md` are gone from the public tree.
