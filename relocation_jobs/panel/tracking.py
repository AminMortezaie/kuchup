...
def tracked_job_dict(
    ...
    *,
    ...
    return {
        ...
        "pinned": as_bool(track.get("pinned")),
        "pinned_at": track.get("pinned_at", "") or "",
    ...
    *,
    ...
    return {
        ...
        **job_location_fields(job),
        ...
        "pinned": as_bool(track.get("pinned")) if logged_in else False,
        ...
        "matches_default_filter": job.get("matches_default_filter", 1),
        "company": company_name,
        "city": company.get("city", ""),
        "size": company.get("size", ""),
        "country": country_key,
