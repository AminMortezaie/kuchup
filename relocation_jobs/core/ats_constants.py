...
KNOWN_ATS: dict[str, tuple[str, str]] = {
    ...
    "Remote OK":           ("remoteok",      "https://remoteok.com/api?tags=dev"),
    "Remote DXB":          ("remotedxb",     "https://www.remotedxb.com/rss"),
    "Joblet":              ("joblet",        "https://joblet.ai/jobs?employmentType=Remote"),
    "Kake":                ("kake",          "https://kake.co/jobs"),
